...
echo "2. 경로 수정 중... (절대 경로 → 상대 경로)"
# 크롬 확장프로그램에서는 절대 경로가 작동하지 않으므로 상대 경로로 변환
sed -i '' 's|href="/|href="./|g' chrome-extension/dist/index.html
sed -i '' 's|src="/|src="./|g' chrome-extension/dist/index.html
